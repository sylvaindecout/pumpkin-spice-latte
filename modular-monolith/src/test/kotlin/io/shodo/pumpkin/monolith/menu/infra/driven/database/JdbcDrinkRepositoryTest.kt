...
@Tag("Integration")
@AutoConfigureJooq
@SpringBootTest(classes = [TestApp::class], properties = ["application.ordering.infra.menu.base-url=-"])
@Sql(executionPhase = BEFORE_TEST_METHOD, scripts = ["/data/init_menu.sql"])
@Sql(executionPhase = AFTER_TEST_METHOD, scripts = ["/data/clean_menu.sql"])
