...
class MappingTest {
    ...
    private val validMenuItemResponseBody =
        MenuItemResponseBody("XXX", MoneyField(0, "EUR", 2), mapOf("XXX" to QuantityField(1, "g")))

    @Test
    fun should_map_MenuItemResponseBody_to_domain_with_name() {
        val dto = validMenuItemResponseBody.copy(name = "LATTE")
    ...
    @Test
    fun should_map_MenuItemResponseBody_to_domain_with_unit_price() {
        val dto = validMenuItemResponseBody.copy(
    ...
    @Test
    fun should_map_MenuItemResponseBody_to_domain_with_recipe() {
        val dto = validMenuItemResponseBody.copy(
            ingredients = mapOf(
